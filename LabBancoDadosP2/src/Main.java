...
public class Main {
	...
	public static void imprimirMenuPrincipal() {
		...
		System.out.println(
				"3 - Imprimir o nome do cliente e quantidade de pedido dos clientes que j� realizaram 3 ou mais pedidos");
		System.out.println(
				"4 - Imprimir todos os cliente com seus pedidos (data e forma de pagamento e pre�o e o nome do produto)");
